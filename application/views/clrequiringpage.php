<div class="card col-md-8 mw-75">
  <div class="card-header">
    <h4 class="card-title"><u>Centerline igénylő form</u></h4>
  ...
  <div class="card-body">
    <div class="row">
      <div class="col-md-12 d-flex justify-content-center">
        <form class="col-sm-12" action="index.php/Clrequiring/form_validation" method="POST" enctype="multipart/form-data" >
          ...
          <div class="form-group">
            <label for="cl_name">Add meg az Új Centerline nevét</label>
          ...
          <div class="form-group">
            <label for="cl_value">Add meg az <b><u>új</u></b> Centerline értéket</label>
            <input type="number" step="0.001" class="form-control" id="cl_value" name="cl_value">
          ...
          <div class="form-group">
            ...
            <select class="form-control" id="measure" name="measure">
                <?php foreach ($measure as $key => $unit_measure) { ?>
                  <option value="<?php print $unit_measure['id'] ?>"><?php print $unit_measure['unit_measure'] ?></option>
              <?php } ?>
            </select>
          ...
          <div class="form-group">
            <label for="reason_dev">Írd le a Centerline igénylés okát</label>
          ...
          <div class="form-group">
            <label for="cl_pic">Kép feltöltés</label>
            <input type="file" class="form-control" id="cl_pic" name="cl_pic">
            <span class="text-danger"><?php echo form_error("cl_pic") ?></span>
          </div>
